...
ActiveRecord::Schema.define(version: 20150111082613) do

  create_table "anime_tags", id: false, force: true do |t|
    t.integer "id"
    t.text    "tag"
  end

  add_index "anime_tags", ["tag"], name: "anime_tags_tagindex"

  create_table "anime_words", force: true do |t|
    t.string "name"
  end
  ...
  add_index "sports_tags", ["tag"], name: "sports_tags_tagindex"
